...
INSERT INTO EMPLOYEE (EMP_ID,EMP_ACCOUNT,EMP_NAME,EMP_ADDRESS,EMP_DATE_OF_BIRTH,GENDER,PHONE,SALARY,DATE_OF_WORK,EMP_TYPE) VALUES 
('EP02','NAM01','NGUYEN HOANG NAM','110/1 CONG LO PHUONG 15 TAN BINH HCM','04-15-2002','MALE','09020421','1000','12-02-2012','SALES')
INSERT INTO EMPLOYEE (EMP_ID,EMP_ACCOUNT,EMP_NAME,EMP_ADDRESS,EMP_DATE_OF_BIRTH,GENDER,PHONE,SALARY,DATE_OF_WORK,EMP_TYPE) VALUES 
...
('VAN01','NGUYEN THI VAN','01-21-2002','FEMALE','0902040129','110/12 CONG LO PHUONG 15 TAN BINH HCM','11-21-2012','3000000','2','R01')
INSERT INTO CUSTOMER(CUS_ACCOUNT,CUS_NAME,CUS_DATE_OF_BIRTH,GENDER,PHONE,CUS_ADDRESS,REGIST_DATE,REVENUE,PRODUCT_NUMBER,RANK_ID) VALUES
('TAI01','NGUYEN VAN TAI','04-01-2002','MALE','0902040129','110/12 CONG LO PHUONG 15 TAN BINH HCM','1-10-2012','12000000','3','R03')
INSERT INTO CUSTOMER(CUS_ACCOUNT,CUS_NAME,CUS_DATE_OF_BIRTH,GENDER,PHONE,CUS_ADDRESS,REGIST_DATE,REVENUE,PRODUCT_NUMBER,RANK_ID) VALUES
('CHI01','NGUYEN LINH CHI','10-02-2001','FEMALE','0902040129','110/12 CONG LO PHUONG 15 TAN BINH HCM','11-16-2012','0','0','R00')

INSERT INTO  PRODUCER(PRODUCER_ID,PRODUCER_NAME) VALUES ('CC1','CONGTYCOPHANABC');
INSERT INTO  PRODUCER(PRODUCER_ID,PRODUCER_NAME) VALUES ('CC2','CONGTYCOPHAN1THANHVIEN');
INSERT INTO  PRODUCER(PRODUCER_ID,PRODUCER_NAME) VALUES ('CC3','CUAHANGCMT8');
INSERT INTO  PRODUCER(PRODUCER_ID,PRODUCER_NAME) VALUES ('CC4','CONGTYCOPHAN5THANHVIEN');

INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L01','COUPE','CC1');
INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L02','SUV','CC2');
INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L03','PICKUP','CC1');
INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L04','VAN','CC3');
INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L05','TRUCK','CC4');
INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L06','CABRIOLET','CC4');
INSERT INTO TYPEPRODUCT(TYPEPRODUCT_ID,TYPEPRODUCT_NAME,PRODUCER_ID) VALUES ('L07','SEDAN','CC3');
...
VALUES ('P001','BUGATTI CHIRON','10','5','NH01','L01','25000000','CC1',(SELECT * FROM OPENROWSET(BULK N'C:\Users\USER\Documents\GitHub\CarSalesSystem\Resources\Images\Cars\Products\bugatichirron.png', SINGLE_BLOB) as T1),'2022','V8','3998','420','4.1','AWD');
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P002','MASERATI MC20','10','6','NH02','L01','7500000','CC1',(SELECT * FROM OPENROWSET(BULK N'C:\Users\USER\Documents\GitHub\CarSalesSystem\Resources\Images\Cars\Products\MC20.png', SINGLE_BLOB) as T1),'2022','V4','2998','300','3.9','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P003','TOYOTA VIOS','20','15','NH03','L01','35000000','CC3',(SELECT * FROM OPENROWSET(BULK N'C:\Users\USER\Documents\GitHub\CarSalesSystem\Resources\Images\Cars\Products\toyota.png', SINGLE_BLOB) as T1),'2018','V4','2998','100','1.9','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P004','TESLA MODLE X','20','1','NH04','L02','29900000','CC2',(SELECT * FROM OPENROWSET(BULK N'C:\Users\USER\Documents\GitHub\CarSalesSystem\Resources\Images\Cars\Products\tesla.png', SINGLE_BLOB) as T1),'2021','V2','2111','150','2.9','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P005','ROYAL ROLL CULLIAN','5','2','NH05','L01','10000000','CC2',(SELECT * FROM OPENROWSET(BULK N'C:\Users\USER\Documents\GitHub\CarSalesSystem\Resources\Images\Cars\Products\rollroycecullian.png', SINGLE_BLOB) as T1),'2018','V4','2998','300','4.1','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P006','LEXUS L63','10','6','NH06','L01','15000000','CC2',(SELECT * FROM OPENROWSET(BULK N'C:\Users\USER\Documents\GitHub\CarSalesSystem\Resources\Images\Cars\Products\lexus.png', SINGLE_BLOB) as T1),'2020','V2.1','127','180','2.9','AWD')
