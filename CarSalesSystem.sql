...
VALUES ('P001','CHIRON','10','5','NH01','L01','25000000','CC1',(SELECT * FROM OPENROWSET(BULK N'D:\UIT\Tài Liệu Học Tập\Năm 3\Kì 1\OOAD\Project\CarSale\Resources\Images\Cars\Products\bugatichirron.png', SINGLE_BLOB) as T1),'2022','V8','3998','420','4.1','AWD');
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P002','MC20','10','6','NH02','L01','7500000','CC7',(SELECT * FROM OPENROWSET(BULK N'D:\UIT\Tài Liệu Học Tập\Năm 3\Kì 1\OOAD\Project\CarSale\Resources\Images\Cars\Products\MC20.png', SINGLE_BLOB) as T1),'2022','V4','2998','300','3.9','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P003','VIOS','20','15','NH03','L01','35000000','CC3',(SELECT * FROM OPENROWSET(BULK N'D:\UIT\Tài Liệu Học Tập\Năm 3\Kì 1\OOAD\Project\CarSale\Resources\Images\Cars\Products\toyota.png', SINGLE_BLOB) as T1),'2018','V4','2998','100','1.9','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P004','MODLE X','20','1','NH04','L02','29900000','CC2',(SELECT * FROM OPENROWSET(BULK N'D:\UIT\Tài Liệu Học Tập\Năm 3\Kì 1\OOAD\Project\CarSale\Resources\Images\Cars\Products\tesla.png', SINGLE_BLOB) as T1),'2021','V2','2111','150','2.9','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P005','CULLIAN','5','2','NH05','L01','10000000','CC6',(SELECT * FROM OPENROWSET(BULK N'D:\UIT\Tài Liệu Học Tập\Năm 3\Kì 1\OOAD\Project\CarSale\Resources\Images\Cars\Products\rollroycecullian.png', SINGLE_BLOB) as T1),'2018','V4','2998','300','4.1','AWD')
INSERT INTO PRODUCT(PRO_ID,PRO_NAME,STORAGE_NUMBER,SELL_NUMBER,IRECEIPT_ID,TYPEPRO_ID,PRICE,PRODUCER_ID,IMG,PRO_YEAR,ENGINELAYOUT,DISPLACEMENT,MAXSPEED,ACCELERATION,TRACTION)
VALUES ('P006','L63','10','6','NH06','L01','15000000','CC5',(SELECT * FROM OPENROWSET(BULK N'D:\UIT\Tài Liệu Học Tập\Năm 3\Kì 1\OOAD\Project\CarSale\Resources\Images\Cars\Products\lexus.png', SINGLE_BLOB) as T1),'2020','V2.1','127','180','2.9','AWD')
...
insert into ORDERBILL(OB_DATEB,CUSTOMER_ID,PRO_ID,QUANTITY,RANK_ID,TOTAL_PRICE) values ('04-01-2002','KH01','P001',1,'R01','25000000')
